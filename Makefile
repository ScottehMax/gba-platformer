...
# Scroll tilemap module
scroll_tilemap.o: $(SRCDIR)/transition/scroll_tilemap.c $(SRCDIR)/transition/scroll_tilemap.h $(SRCDIR)/transition/transition.h $(SRCDIR)/level/level.h $(GENDIR)/connections.h
	$(CC) $(CFLAGS) -c $< -o $@
